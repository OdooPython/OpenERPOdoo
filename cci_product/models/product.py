...
class product_template(osv.osv):
	...
	#'type': fields.selection([('visite', 'Visite'), ('foire', 'Foire et Manifestation'), ('formation', 'Formation'),('service', 'Adhésion')], 'Product Type', required=True),
	'type': fields.many2one('product.type', 'Type Product'),
